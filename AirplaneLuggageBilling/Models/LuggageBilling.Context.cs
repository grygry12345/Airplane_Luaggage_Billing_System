...
namespace AirplaneLuggageBilling.Models
{
    ...
    public partial class LugageBillingEntities1 : DbContext
    {
        public LugageBillingEntities1()
            : base("name=LugageBillingEntities1")
        {
        }
        ...
        [DbFunction("LugageBillingEntities1", "luggagesDest")]
        public virtual IQueryable<luggagesDest_Result> luggagesDest(string destName)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<luggagesDest_Result>("[LugageBillingEntities1].[luggagesDest](@destName)", destNameParameter);
        }
